...
const DashboardLayout = ({ children, className = '' }: DashboardLayoutProps) => {
  ...
  const { currentUser, logout, hasRole } = useRegistrations();
      ...
      <div className="min-h-screen flex w-full bg-sidebar/5">
        <Sidebar>
          <SidebarHeader className="py-4">
            <div className="flex items-center gap-2 px-2">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-sm">PPDB</span>
          ...
          <SidebarFooter className="py-2">
            <div className="px-3">
              {currentUser && (
                <div className="mb-2 px-2 py-2 rounded-md bg-sidebar-accent/50">
